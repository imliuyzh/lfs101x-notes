...
## Linux Terminology
- Kernel
  - Core of the operating system for controlling the hardware and makes it to interact with applications
- Boot loader
...
- Shell
  - The command line interpreter that interprets the command line input to instruct the operating system
