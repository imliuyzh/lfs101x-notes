...
For the newer system-based distributions, you can stop the GUI desktop with the `telinit` command: `$ sudo telinit 3`.

You can restart it (after logging into the console) with: `$ sudo telinit 5`.
